...
class _Injector$minimalApp extends _i2.HierarchicalInjector {
  ...
  _i3.ThrowingSlowComponentLoader _getThrowingSlowComponentLoader$0() => _field0 ??= new _i3.ThrowingSlowComponentLoader();
  _i4.ComponentLoader _getComponentLoader$1() => _field1 ??= new _i4.ComponentLoader();
  dynamic _getdynamic$2() => _field2 ??= _i3.createRandomAppId();
  _i5.DomSanitizationServiceImpl _getDomSanitizationServiceImpl$3() => _field3 ??= new _i5.DomSanitizationServiceImpl();
  dynamic _getExisting$4() => this.get(_i7.DomSanitizationService);
  _i6.BrowserExceptionHandler _getBrowserExceptionHandler$5() => _field5 ??= new _i6.BrowserExceptionHandler();
