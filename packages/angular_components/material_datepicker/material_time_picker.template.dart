...
import '../material_input/base_material_input.dart' as import26;
...
class ViewMaterialTimePickerComponent0 extends AppView<import2.MaterialTimePickerComponent> {
  ...
  ViewMaterialTimePickerComponent0(AppView<dynamic> parentView, int parentIndex) : super(import12.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce) {
    rootEl = import14.document.createElement('material-time-picker');
    _renderType ??= import15.appViewUtils.createRenderType((import16.isDevMode ? 'asset:angular_components/lib/material_datepicker/material_time_picker.dart' : null), ViewEncapsulation.Emulated, styles$MaterialTimePickerComponent);
  ...
  ComponentRef<import2.MaterialTimePickerComponent> build() {
    ...
    _MaterialDropdownSelectComponent_0_5 = (import16.isDevMode
        ? import18.debugInjectorWrap(import5.MaterialDropdownSelectComponent, () {
            return import5.MaterialDropdownSelectComponent(parentView.injectorGet(import19.IdGenerator, viewData.parentIndex, null), parentView.injectorGet(import20.PopupSizeProvider, viewData.parentIndex, null), parentView.injectorGet(const import21.OpaqueToken<dynamic>('isRtl'), viewData.parentIndex, null), null, null, _el_0);
          })
        : import5.MaterialDropdownSelectComponent(parentView.injectorGet(import19.IdGenerator, viewData.parentIndex, null), parentView.injectorGet(import20.PopupSizeProvider, viewData.parentIndex, null), parentView.injectorGet(const import21.OpaqueToken<dynamic>('isRtl'), viewData.parentIndex, null), null, null, _el_0));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, const import21.MultiToken<dynamic>('NgValidators')) && (3 == nodeIndex))) {
      return _NgValidators_3_6;
    }
    if ((identical(token, import8.NgModel) && (3 == nodeIndex))) {
      return _NgModel_3_7;
    }
    if ((identical(token, import22.NgControl) && (3 == nodeIndex))) {
      return _NgControl_3_8;
    }
    if (((((identical(token, import9.MaterialInputComponent) || identical(token, import23.ReferenceDirective)) || identical(token, import24.Focusable)) || identical(token, import25.HasDisabled)) && (3 == nodeIndex))) {
      return _MaterialInputComponent_3_9;
    }
    if ((identical(token, import26.BaseMaterialInput) && (3 == nodeIndex))) {
    ...
    if (((((((((identical(token, import5.MaterialDropdownSelectComponent) || identical(token, import27.DropdownHandle)) || identical(token, import25.HasDisabled)) || identical(token, import28.HasRenderer)) || identical(token, import29.DeferredContentAware)) || identical(token, import30.SelectionContainer)) || identical(token, import20.PopupSizeProvider)) || identical(token, import31.ActivationHandler)) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
