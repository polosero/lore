...
class ViewMaterialTreeDropdownComponent0 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    ...
    _PopupSourceDirective_0_6 = (import15.isDevMode
        ? import17.debugInjectorWrap(import4.PopupSourceDirective, () {
            return import4.PopupSourceDirective(parentView.injectorGet(import19.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import20.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import21.Focusable, viewData.parentIndex, null), null);
          })
        : import4.PopupSourceDirective(parentView.injectorGet(import19.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import20.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import21.Focusable, viewData.parentIndex, null), null));
    ...
    _MaterialPopupComponent_4_8 = (import15.isDevMode
        ? import17.debugInjectorWrap(import8.MaterialPopupComponent, () {
            return import8.MaterialPopupComponent(parentView.injectorGet(import23.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import8.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import24.NgZone, viewData.parentIndex), parentView.injectorGet(import25.OverlayService, viewData.parentIndex), parentView.injectorGet(import18.DomService, viewData.parentIndex), parentView.injectorGet(import26.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import27.OpaqueToken<List<import29.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import27.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import30.PopupSizeProvider, viewData.parentIndex, null), _compView_4.ref, _appEl_4, ElementRef(_el_4));
          })
        : import8.MaterialPopupComponent(parentView.injectorGet(import23.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import8.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import24.NgZone, viewData.parentIndex), parentView.injectorGet(import25.OverlayService, viewData.parentIndex), parentView.injectorGet(import18.DomService, viewData.parentIndex), parentView.injectorGet(import26.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import27.OpaqueToken<List<import29.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import27.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import30.PopupSizeProvider, viewData.parentIndex, null), _compView_4.ref, _appEl_4, ElementRef(_el_4)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import8.MaterialPopupComponent) || identical(token, import32.DeferredContentAware)) || identical(token, import33.DropdownHandle)) && ((4 <= nodeIndex) && (nodeIndex <= 7)))) {
