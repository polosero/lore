define(['dart_sdk'], function(dart_sdk) {
  ...
  const typed_buffers = Object.create(_root);
  ...
  const _typedBuffer = Symbol('_typedBuffer');
  const _defaultValue = Symbol('_defaultValue');
  const _createBuffer = Symbol('_createBuffer');
  const _createBiggerBuffer = Symbol('_createBiggerBuffer');
  const _grow = Symbol('_grow');
  const _add = Symbol('_add');
  const _addAll = Symbol('_addAll');
  const _insertKnownLength = Symbol('_insertKnownLength');
  const _ensureCapacity = Symbol('_ensureCapacity');
  const _setRange = Symbol('_setRange');
